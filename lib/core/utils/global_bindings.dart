...
import '../../data/repositores/event_repository.dart';
...
class GlobalBindings extends Bindings {
  ...
  void dependencies() {
    ...
    Get.put<DadyJokeService>(DadyJokeService(), permanent: true);

    Get.put<DadyJokeRepository>(DadyJokeRepository(), permanent: true);
    Get.put<EventRepository>(EventRepository(), permanent: true);
  }
}
